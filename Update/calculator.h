...
string __operators[] = { "+", "-", "*", "/", "^", "(", ")", "sin", "cos", "tan", "log", "log10", "asin", "acos", "atan", "sqrt", "cubr" };
string __constants[] = { "pi", "phi", "e" };
string __binary_op[] = { "+", "-", "*", "/", "^" };
string __empties[] = { " ", "\t", "\n" };


vector<string> operators(__operators, __operators + 17);
vector<string> constants(__constants, __constants + 3);
vector<string> binary_op(__binary_op, __binary_op + 5);
vector<string> empties(__empties, __empties + 3);
